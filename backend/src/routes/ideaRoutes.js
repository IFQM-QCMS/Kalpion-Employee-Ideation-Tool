/** Idea routes - /api/ideas/* Ported from PHP api/ideas.php. */
...
// Archiving and patentability are organisation-admin decisions (MOM §13.2, §13.10).
// requireRole gates the route; ideaService re-checks, because a service that trusts its
// caller's role has no defence if a new route forgets to.
...
// The patentable tick is not an admin decision - a submitter may raise it on their own
// idea and a reviewer on any idea. The service does the real check.
