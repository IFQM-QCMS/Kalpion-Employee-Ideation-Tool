...
export default {
  ...
  'login.forgot_body':'Enter the email address registered on your account. If it matches an account, we’ll send a link to set a new password. The link is valid for one hour.',
  'login.forgot_send':'Send reset link',
  'login.forgot_sending':'Sending…',
  'login.forgot_invalid':'Enter a valid email address.',
  ...
  'stage.immediate_manager_note':'only for large companies',
