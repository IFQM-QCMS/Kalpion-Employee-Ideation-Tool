...
export default {
  ...
  'msgb.st_pipeline':'Trial pipeline',
  'msgb.st_pipeline_hint':'if every trial converts',
  ...
  'msgb.m_paid_hint':'How many billing periods this payment covers. The period end moves forward by that much, and an organisation on hold for non-payment is reinstated. This records that money arrived — it does not take payment.',
