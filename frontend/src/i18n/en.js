...
export default {
  ...
  'imp.password_notice':'Employees with an email address are sent a temporary password directly — you do not have to pass anything on to them. Employees without one get the first 4 characters of their username plus the last 4 digits of their phone number, shown in the table below, which you must give them yourself. Everyone must change it the first time they sign in, and cannot use anything else until they do. A password built from a username and a phone number can be worked out by a colleague, so ask those employees to sign in promptly.',
  ...
  'imp.tell_employees':'Tell each employee without an email address their first-time password: the first 4 characters of their username followed by the last 4 digits of their phone number. Example: username yashas123 on 7975495881 → yash5881. Employees who have an email address were sent theirs directly and need nothing from you. Everyone is asked to choose a new password as soon as they sign in.',
  ...
  'admin.uf_pw_will_derive':'No email address given, so the temporary password will be the first 4 characters of their username plus the last 4 digits of their phone number. It will be shown to you once, and you must pass it on yourself.',
