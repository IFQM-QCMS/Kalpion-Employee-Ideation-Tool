...
export default {
  ...
  'area.waste_reduction':'Waste Reduction',
  'area.simplification':'Simplification',
  ...
  'info.qcms_pushed':'OctaQube is the separate quality system where approved work is actually tracked. This counts the approved ideas handed over to it: the point where an idea stops being a suggestion and becomes tracked work.',
  ...
  'pa.qcms_pushed':'Sent to OctaQube',
  ...
  'form.impact_areas_hint':'Choose as many as apply. Tap again to remove one.',
  ...
  'analytics.impl_rate_sub':'Ideas Sent to OctaQube',
  ...
  'pw.why':'You signed in with a temporary password that was set up for you when your account was created. Anyone could guess it, so you need to replace it before you can use the app.',
  ...
  'admin.approved_sub':'Ideas approved in your organisation. Push them to OctaQube for implementation.',
  'admin.approved_none':'No approved ideas yet.',
  'admin.qcms_push_all':'Push all to OctaQube',
  'admin.qcms_push':'Push',
  'admin.qcms_not_configured':'OctaQube is not set up yet. Paste your API key and enable it in the API & Integration tab.',
  'admin.qcms_push_result':'Pushed to OctaQube - {i} imported, {d} duplicate, {f} failed.',
  ...
  'admin.qcms_heading':'OctaQube Integration',
  'admin.qcms_sub':'Paste the API key generated in OctaQube to push your approved ideas there for implementation.',
  'admin.qcms_enabled':'Enable OctaQube integration',
  'admin.qcms_api_key':'OctaQube API Key',
  ...
  'admin.qcms_base_url':'OctaQube Base URL',
  'admin.qcms_base_hint':'Default: {url}. Leave blank to use it.',
  'admin.qcms_saved':'OctaQube integration settings saved.',
  'admin.qcms_endpoint_title':'Integration Endpoint: Send Approved Ideas',
  'admin.qcms_endpoint_sub':'Approved ideas are sent to OctaQube in this format (server-side, over your API key).',
  ...
  'nav.help':'Help',
  'msgb.st_breakdown':'the five states below add up to this',
  'msgb.st_grace_hint':'overdue, not yet held',
  'msgb.st_crosscut':'counted above as well',
  'ar.no_match':'No match. An idea can only be routed to somebody who holds a role in the approval path.',
  'ar.not_routable':'{name} holds no role in this organisation’s approval path, so an idea cannot be routed to them.',
  'ar.unavailable':'unavailable',
  'dash.sub_admin_pending':'{n} idea(s) are awaiting a decision from their reviewers.',
  'admin.uf_manager_current':'current',
  'form.attach_bad_type':'"{name}" cannot be attached. Allowed file types: {types}.',
  'form.attach_failed':'The idea was submitted, but this attachment could not be saved: {names}. You can add it from the idea itself.',
  'idea.draft_unfinished':'This idea is a draft. It has not been sent to anybody yet.',
  'idea.continue_draft':'Continue editing',
  'detail.created_at':'Created on',
  'hier.confirm_live':'{n} idea(s) are part-way through the current approval chain. Saving applies the new chain to them straight away, which can add or remove a stage they still have to pass. Save anyway?',
  'nav.more':'More',
  'nav.menu':'Menu',
  ...
  'analytics.impl_velocity_sub':'Ideas Sent to OctaQube in the last 30 days',
  ...
  'qc.in_qc':'In OctaQube',
  'qc.in_qc_hint':'Approved and sent to OctaQube, where it is tracked as work.',
  'qc.failed':'OctaQube send failed',
  'qc.failed_hint':'Approved, but the last attempt to send it to OctaQube did not succeed. It can be sent again.',
  ...
  'status.returned':'Sent back for changes',
  'status.resubmitted':'Resubmitted',
  'status.reopened':'Reopened',
  'status.reviewed':'Reviewed',
  'review.send_back':'Send back for improvement',
  'review.will_send_back':'The idea goes back to its author as a draft, with your note. When they resubmit it comes straight back to you - it does not restart the approval path.',
  'review.send_back_needs_reason':'Say what needs to change - the author sees this note.',
  'review.send_back_ph':'What should the author change or add?',
  'review.sent_back_ok':'Sent back to the author for changes.',
  'review.next_direction':'After your approval',
  'review.next_close':'Close as approved (end of the approval path)',
  'review.next_forward':'Approve and forward to {stage}',
  'review.next_forward_hint':'The idea goes to {stage} for a further decision before it closes. This applies to this idea only; the organisation’s approval path is unchanged.',
  'review.forward_holders':'Held by {names}',
  'review.undo_reject':'Undo rejection',
  'review.undo_reject_confirm':'Put this idea back into review at the stage it was rejected from?',
  'review.undo_reject_note':'Note to the author (optional)',
  'review.undo_reject_ok':'Rejection reversed - the idea is back in review.',
  'idea.returned_banner':'Sent back for changes by {name} ({stage})',
  'idea.returned_reason':'What was asked',
  'idea.returned_hint':'Edit the idea and submit it again. It goes straight back to {name}.',
  'idea.edit_resubmit':'Edit & resubmit',
  'idea.returned_badge':'Needs changes',
  'idea.forwarded_stage':'forwarded',
  'idea.edit_not_draft':'Only your own drafts can be opened for editing.',

  // Audit trail filters
  'audit.filter_action':'Action',
  'audit.filter_idea':'Idea code or title',
  'audit.filter_actor':'Who',
  ...
  'admin.role_none':'nobody yet',

  // Bulk update
  'admin.bulk_update':'Bulk update',
  'import.update_title':'Bulk update employee details',
  'import.update_sub':'Upload the same spreadsheet with the details you want to change. Rows are matched on employee_id; only the cells you fill in are changed - a blank cell leaves that detail as it is. Passwords are never touched.',
  'import.update_preview':'Check the sheet',
  'import.update_apply':'Apply {n} update(s)',
  'import.update_done':'{n} employee(s) updated, {u} unchanged, {e} rejected.',
  'import.update_unchanged':'Unchanged rows',
  'import.update_changes':'What will change',
  'import.required_note':'Columns marked * are required for a new account. The others may be left blank or left out of the sheet.',
  'import.required_cols':'Required: {cols}',
  'import.optional_cols':'Optional: {cols}',
};
