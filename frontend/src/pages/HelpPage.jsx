...
// Help, written for the person using the product rather than the person who built it.
...
export default function HelpPage() {
  ...
  return (
    <>
      ...
      {/* The manual. It has existed in docs/ since it was written and nothing in the product pointed at it, so the only people who ever saw it were the ones sent a copy by hand. */}
      <div className="card" style={{ marginBottom: 18, display: 'flex', gap: 14,
        ...
        {/* The same component the dashboards use, so there is one download path and one set of failure messages rather than two. */}
        {/* Was a PDF download. The manual is a page now, so this points at it - somebody who came to Help looking for the manual still finds it. */}
